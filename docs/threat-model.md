...
Project-specific acceptance focus: Validate clean-room deployment, connector redundancy, application reachability only for assigned identities, Conditional Access outcomes, DNS failure modes, no inbound ports, upgrades, and teardown.
